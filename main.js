...
async function fetchMeteo(ville) {
    const url = `http://api.openweathermap.org/data/2.5/weather?q=${ville}&appid=f06b549afb8f5793fefeeadd02f0ee54`;
    ...
    const url5Jours = `http://api.openweathermap.org/data/2.5/forecast?q=${ville}&appid=f06b549afb8f5793fefeeadd02f0ee54`;
